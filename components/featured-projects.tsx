        ...
        >
          <div className="flex flex-col h-full">
            <div className="grow">
              ...
              <div className="text-lg font-aspekta font-[650] mb-1">Pipe4j</div>
              <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">A cleaner way to write Java code, through a pipeline.</p>
            </div>
